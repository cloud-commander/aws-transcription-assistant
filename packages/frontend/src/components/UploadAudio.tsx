...
import { Label, Button, Header, Form, Modal } from 'semantic-ui-react';
                    ...
                    <Form.Group inline>
                        ...
                        <Label as="label" basic htmlFor="upload">
                            <Button
                                ...
                                label={{
                                    basic: true,
                                    content: 'Select local audio (*.mp3/wav)',
                                }}
                                labelPosition="right"
                            />
                            <input hidden id="upload" multiple type="file" onChange={this.handleFileUpload}/>
                        </Label>
                    </Form.Group>
                </Form>
